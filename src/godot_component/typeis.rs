...
impl typeis::Host for GodotCtx {
    fn var_type(&mut self, var: WasmResource<Variant>) -> AnyResult<typeis::VariantType> {
        Ok(match self.get_var(var).get_type() {
